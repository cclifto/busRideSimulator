...
import CleanShirtFooter from './cleanShirtFooter'

var AllOver = React.createClass({	
		...
		return (
			<div className="list-view">
				...
				<div className="view-container">
					...
					<p>>>Oh god. That didn't help at ALL. You just spread it all over your shirt. You just got grease and cream cheese EVERYWHERE. What the fuck are you gonna do? You gotta go to work and you're still on your probationary period!</p>
				</div>
				<CleanShirtFooter />
			</div>
		)
