var textAndChoices = {
	...
	firstView: {
		display_text: ">>You are riding the bus in your town. It's a prime example of public transit. It's cheap, affordable and, get this, good for the environment! Good on you, buddy!\n>>So... like... what do you wanna do?",
		choices: ["TALK TO NEIGHBOR", "EAT LUNCH"]
	},
	...
	eatLunch: {
		...
		choices: ["CLEAN SHIRT", "TAKE OFF SHIRT"]
	},
	...
	cleanShirt: {
		...
		choices: ["SCREW IT, I'M GOING TO WORK", "BAIL"]
	},
	...
	talkNeighbor: {
		...
		choices: ["TURN AWAY", "OFFER BREATH MINT"]
	},
	...
	breathMint: {
		...
		choices: ["READ IT", {buttonText: "KEEP WORKING",
